...
class MockUserApi extends _i1.Mock implements _i3.UserApi {
  ...
  @override
  _i4.Future<List<dynamic>> getUsers() => (super.noSuchMethod(
        Invocation.method(
          #getUsers,
          [],
        ),
  ...
  @override
  _i4.Future<List<dynamic>> getFollowers(String? userId) => (super.noSuchMethod(
        Invocation.method(
          #getFollowers,
          [userId],
        ),
  ...
  @override
  _i4.Future<List<dynamic>> getFollowings(String? userId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getFollowings,
          [userId],
  ...
  @override
  _i4.Future<List<dynamic>> getAdminUsers() => (super.noSuchMethod(
        Invocation.method(
          #getAdminUsers,
          [],
        ),
  ...
  @override
  _i4.Future<_i2.UserDTO> promote(String? id) => (super.noSuchMethod(
        Invocation.method(
          #promote,
          [id],
        ),
  ...
  @override
  _i4.Future<_i2.UserDTO> demote(String? id) => (super.noSuchMethod(
        Invocation.method(
          #demote,
          [id],
        ),
