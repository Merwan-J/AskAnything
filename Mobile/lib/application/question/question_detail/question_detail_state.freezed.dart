...
class __$$QuestionDetailStateErrorCopyWithImpl<$Res>
    extends _$QuestionDetailStateCopyWithImpl<$Res, _$QuestionDetailStateError>
...
class _$QuestionDetailStateError implements QuestionDetailStateError {
  const _$QuestionDetailStateError(this.questionFailure);
  ...
  @override
  String toString() {
    return 'QuestionDetailState.error(questionFailure: $questionFailure)';
  }
...
abstract class QuestionDetailStateError implements QuestionDetailState {
  const factory QuestionDetailStateError(
      final QuestionFailure questionFailure) = _$QuestionDetailStateError;
