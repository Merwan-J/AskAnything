...
mixin _$LoginState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(Map<String, dynamic> user, String token) success,
    required TResult Function(AuthFailure error) failure,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(Map<String, dynamic> user, String token)? success,
    TResult? Function(AuthFailure error)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$LoginStateSuccess implements LoginStateSuccess {
  const _$LoginStateSuccess(final Map<String, dynamic> user, this.token)
      : _user = user;
...
class __$$LoginStateFailureCopyWithImpl<$Res>
    extends _$LoginStateCopyWithImpl<$Res, _$LoginStateFailure>
...
abstract class LoginStateFailure implements LoginState {
  const factory LoginStateFailure(final AuthFailure error) =
      _$LoginStateFailure;
